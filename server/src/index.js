...
app.get("/convert", async (req, res) => {
  ...
  const currencyURL = `https://openexchangerates.org/api/historical/${date}.json?app_id=07f5668ef9ee404eb1ba98b84ff8be58`;
  const namesURl = `https://openexchangerates.org/api/currencies.json?app_id=07f5668ef9ee404eb1ba98b84ff8be58`;
  try {
